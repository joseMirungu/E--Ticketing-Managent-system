                  ...
                  <div class="tabWrap">
                    ...
                    <article class="tabContent" id="tabContent1">
                        ...
                        <table id="employeeTable" class="table table-striped">
                            ...
                            <style>#employeeTable td + td + td + td + td + td {color: blue; font-weight: bold;} </style>
                            <tbody>
                                <?php 
                    ...
                    <article class="tabContent" id="tabContent2">
                        <table id="employeeTable1" class="table table-striped">
                            <thead>
                                <tr>
                                   <th>Id</th> 
                                   <th>Name</th>
                    ...
                    <article class="tabContent" id="tabContent3">
                      <table id="employeeTable2" class="table table-striped">
                            <thead>
                                <tr>
                                   <th>Id</th> 
                                   <th>Name</th>
...
?>                  
                    <form id="assignT" name="assignT" >
                    <input type="text" style="display: none;" id="issue" name="issue" value=<?php echo $complaint['ComplaintId']; ?>>
                    <select id = "expert" name ="expert" style=" padding: 5px 10px; border: none; background-color: #333; color: #fff; cursor: pointer;">
    ...
    $.ajax({
      ...
      data: dataString,
       ...
       // $("#contact_form").load(" #contact_form");
        // $("#contact_form").load(" #contact_form > *");
        $('#ticketassign').load(document.URL + ' #ticketassign');
           //window.location.reload();
        // window.location.href = 'index.php#D2';
      }
    });
    ...
    e.preventDefault();
            ...
            $query = "SELECT ComplaintId, Description, Department, Location, Timestart, Expert_assigned, complaints.Expert_assigned,users.Name FROM complaints LEFT JOIN users ON users.userID= complaints.Expert_assigned WHERE Expert_assigned != '' ORDER BY `ComplaintId` desc";
        ...
        <tr>
            ...
            ?>                     
                    ...
                    <form id="transferT" name="transferT"  >
                    <input type="text" style="display: none;" id="issue" name="issue" value=<?php echo $complaint['ComplaintId']; ?>>
                    <select id = "expert" name ="expert" style=" padding: 5px 10px; border: none; background-color: #333; color: #fff; cursor: pointer;">
                    <option value="" disabled selected>Select Officer</option>
                    <?php foreach ($officers as $officer) {  
                        ...
                        $.ajax({
                          ...
                          data: dataString,
                           ...
                           success: function(jqXHR, textStatus, errorThrown) {
                            ...
                            $('#tickettransfer').load(document.URL + ' #tickettransfer');
                               window.location.reload();
                          }
                        });
    ...
    e.preventDefault();
            ...
            <li id="D3">
                  ...
                  <div class="tabWrap">
                    ...
                    <!-- Links for Desktop -->
                    <input id="tabLink7" type="radio" name="tabs" checked >
                    <label for="tabLink7" class="desktopTabLink" style="width: 32%;">Users</label>
                    ...
                    <!-- Links for Mobile -->
                    <input id="tabLinkMobile7" type="radio" name="tabs" checked>
                    <label for="tabLinkMobile7" class="mobileAccordionLink">Users</label>
                    
                    <!-- Content -->
                    <article class="tabContent" id="tabContent7">
